...
- Integrated **OpenAI** for intelligent, context-aware voice responses
- Architected for scalable multi-user concurrent sessions
- **Stack:** `Python` `LiveKit` `OpenAI` `WebRTC` `REST APIs`
...
- Structured data retrieval pipeline optimized for speed and accuracy
- Built with clean modular architecture for easy extensibility
- **Stack:** `Python` `GenAI` `MongoDB` `REST APIs`
